...
###############################################################################
# Submits a job to the development queue of Stampede 2's KNL nodes.
#
...
#SBATCH -J rhea         # Job name
#SBATCH -o rhea.o%j     # Output to stdout of this script
#SBATCH -e rhea.e%j     # Output to stderr of this script
#SBATCH -p development  # Queue name
#SBATCH -N 2            # Total number of nodes (required); max=16
#SBATCH -n 68           # Total number of mpi tasks; max=1088
#SBATCH -t 02:00:00     # Allocated runtime; max=2hrs
...
declare -r BUILD_DIR="$HOME/build/dev/rhea"
declare -r EXEC_PATH="$BUILD_DIR/example/basic/rhea_basic"

########################################
# Job Directories and File Paths
########################################

declare -r JOB_DIR="$SCRATCH/runs/rhea/<JOB_DIRECTORY_YYYY-MM-DD>"
