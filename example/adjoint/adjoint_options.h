...
typedef enum
{
  ...
  SUBD_ADJOINT_FIELD_VISC_RHEA_UM_LEFT = 5,
  SUBD_ADJOINT_FIELD_VISC_RHEA_UM_RIGHT = 6,
...
typedef enum
{
  ...
  SUBD_ADJOINT_STENCIL_VISC_RHEA_UM_LEFT = 3,
  SUBD_ADJOINT_STENCIL_VISC_RHEA_UM_RIGHT = 4,
  SUBD_ADJOINT_STENCIL_VISC_CUSTOM_LAYERS_UM = 11,
  SUBD_ADJOINT_STENCIL_VISC_CUSTOM_LAYERS_LM = 12
}
