...
typedef enum
{
  ...
  RHEA_DOMAIN_BOUNDARY_FACE_BASE = 0,   /* -z */
  RHEA_DOMAIN_BOUNDARY_FACE_TOP,        /* +z */
  RHEA_DOMAIN_BOUNDARY_FACE_SIDE1,      /* -x */
  RHEA_DOMAIN_BOUNDARY_FACE_SIDE2,      /* +x */
  RHEA_DOMAIN_BOUNDARY_FACE_SIDE3,      /* -y */
  RHEA_DOMAIN_BOUNDARY_FACE_SIDE4,      /* +y */
  RHEA_DOMAIN_BOUNDARY_FACE_N           /* #faces */
}
